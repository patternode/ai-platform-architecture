...
|----------|-------|
| **ABB ID** | `AB-035` |
| **ABB Name** | Conversation Summarizer |
| **Version** | `1.0.0` |
| **Status** | `Preliminary` |
...
|---------------|-----------------|-------------|----------|
| CP-017 | Conversation Summarization | Summarize conversation history | Should Have |
| CP-144 | Summarization | Summarize documents and conversations | Should Have |
...
|---------------|-----------------|-------------|-------|----------------------|
| CP-017 | Conversation Summarization | Summarize conversation history | L2 | Enables summarize conversation history |
| CP-144 | Summarization | Summarize documents and conversations | L2 | Enables summarize documents and conversations |

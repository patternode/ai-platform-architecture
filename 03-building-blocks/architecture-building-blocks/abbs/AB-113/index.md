...
|----------|-------|
| **ABB ID** | `AB-113` |
| **ABB Name** | Access Control & Identity Management |
| **Version** | `1.0.0` |
| **Status** | `Preliminary` |
| **Category** | `Security` |
...
|---------------|-----------------|-------------|----------|
| CP-290 | Authentication | Verify user/service identity | Should Have |
| CP-291 | Authorization | Role-based access control | Should Have |
| CP-292 | Identity Management | Manage identities and permissions | Should Have |
...
|---------------|-----------------|-------------|-------|----------------------|
| CP-290 | Authentication | Verify user/service identity | L2 | Enables verify user/service identity |
| CP-291 | Authorization | Role-based access control | L2 | Enables role-based access control |
| CP-292 | Identity Management | Manage identities and permissions | L2 | Enables manage identities and permissions |

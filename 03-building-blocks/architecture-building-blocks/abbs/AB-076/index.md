...
|----------|-------|
| **ABB ID** | `AB-076` |
| **ABB Name** | Event Producer Adapter |
| **Version** | `1.0.0` |
| **Status** | `Preliminary` |
...
|---------------|-----------------|-------------|----------|
| CP-260 | Data Ingestion | Ingest data from multiple sources | Should Have |
...
|---------------|-----------------|-------------|-------|----------------------|
| CP-260 | Data Ingestion | Ingest data from multiple sources | L2 | Enables ingest data from multiple sources |

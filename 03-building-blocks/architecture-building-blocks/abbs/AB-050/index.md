...
|----------|-------|
| **ABB ID** | `AB-050` |
| **ABB Name** | Large Language Model Service |
| **Version** | `1.0.0` |
| **Status** | `Preliminary` |
| **Category** | `GenAI` |
...
|---------------|-----------------|-------------|----------|
| CP-129 | LLM Gateway | Unified access to multiple LLM providers | Should Have |
| CP-143 | Text Generation | Generate natural language text | Should Have |
...
|---------------|-----------------|-------------|-------|----------------------|
| CP-129 | LLM Gateway | Unified access to multiple LLM providers | L2 | Delivers llm gateway as a managed service |
| CP-143 | Text Generation | Generate natural language text | L2 | Delivers text generation as a managed service |
...
| UC-005 | Document Processing | AI Document Processing for applications and compliance verification. | Provides managed services for Document Processing |
...
| UC-007 | Customer Service | Generate interaction summaries, agent-assist features, customer self-service. | Provides managed services for Customer Service |
...
| UC-010 | Software Development | GenAI can automate key development tasks, enhancing productivity. | Provides managed services for SDLC |

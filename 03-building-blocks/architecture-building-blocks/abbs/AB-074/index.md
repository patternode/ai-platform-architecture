...
|---------------|-----------------|-------------|----------|
| CP-262 | Schema Registry | Manage data schemas and evolution | Should Have |
| CP-269 | Event Streaming | Publish/subscribe event model | Should Have |
| CP-270 | Event Sourcing | Immutable event stream as truth | Should Have |
...
|---------------|-----------------|-------------|-------|----------------------|
| CP-262 | Schema Registry | Manage data schemas and evolution | L2 | Brokers events and messages for schema registry |
| CP-269 | Event Streaming | Publish/subscribe event model | L2 | Brokers events and messages for event streaming |
| CP-270 | Event Sourcing | Immutable event stream as truth | L2 | Brokers events and messages for event sourcing |

...
|----------|-------|
| **ABB ID** | `AB-124` |
| **ABB Name** | Model Watermarking Service |
| **Version** | `1.0.0` |
| **Status** | `Preliminary` |
| **Category** | `Security` |
...
|---------------|-----------------|-------------|----------|
| CP-304 | Model Watermarking | Protect model IP | Should Have |
...
|---------------|-----------------|-------------|-------|----------------------|
| CP-304 | Model Watermarking | Protect model IP | L2 | Delivers model watermarking as a managed service |

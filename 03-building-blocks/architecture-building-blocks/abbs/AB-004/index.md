...
|---------------|-----------------|-------------|----------|
| CP-108 | Task Planning | Break complex goals into steps | Should Have |
...
|---------------|-----------------|-------------|-------|----------------------|
| CP-108 | Task Planning | Break complex goals into steps | L2 | Enables break complex goals into steps |

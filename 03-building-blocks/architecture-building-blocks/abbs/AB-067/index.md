...
|----------|-------|
| **ABB ID** | `AB-067` |
| **ABB Name** | Cost Attribution Engine |
| **Version** | `1.0.0` |
| **Status** | `Preliminary` |
| **Category** | `Governance` |
...
|---------------|-----------------|-------------|----------|
| CP-360 | Cost Attribution | Attribute AI costs to use cases and models | Should Have |
| CP-363 | Chargeback Reporting | Generate cost allocation reports | Should Have |
...
|---------------|-----------------|-------------|-------|----------------------|
| CP-360 | Cost Attribution | Attribute AI costs to use cases and models | L2 | Core processing engine that governs cost attribution |
| CP-363 | Chargeback Reporting | Generate cost allocation reports | L2 | Core processing engine that governs chargeback reporting |

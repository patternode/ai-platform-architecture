...
|----------|-------|
| **ABB ID** | `AB-121` |
| **ABB Name** | Homomorphic Encryption Service |
| **Version** | `1.0.0` |
| **Status** | `Preliminary` |
| **Category** | `Security` |
...
|---------------|-----------------|-------------|----------|
| CP-300 | Homomorphic Encryption | Compute on encrypted data | Should Have |
...
|---------------|-----------------|-------------|-------|----------------------|
| CP-300 | Homomorphic Encryption | Compute on encrypted data | L2 | Delivers homomorphic encryption as a managed service |

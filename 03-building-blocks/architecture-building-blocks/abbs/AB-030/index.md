...
|---------------|-----------------|-------------|----------|
| CP-010 | Intent Classification | Understand user intent | Should Have |
...
|---------------|-----------------|-------------|-------|----------------------|
| CP-010 | Intent Classification | Understand user intent | L2 | Enables understand user intent |

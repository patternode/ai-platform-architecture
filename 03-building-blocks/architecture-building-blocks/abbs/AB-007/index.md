...
|----------|-------|
| **ABB ID** | `AB-007` |
| **ABB Name** | Multi-Agent Communication Bus |
| **Version** | `1.0.0` |
| **Status** | `Preliminary` |
| **Category** | `Agentic` |
...
|---------------|-----------------|-------------|----------|
| CP-114 | Inter-Agent Communication | Message passing between agents | Should Have |
...
|---------------|-----------------|-------------|-------|----------------------|
| CP-114 | Inter-Agent Communication | Message passing between agents | L2 | Enables message-based communication for inter-agent communication |

...
|----------|-------|
| **ABB ID** | `AB-120` |
| **ABB Name** | Federated Learning Platform |
| **Version** | `1.0.0` |
| **Status** | `Preliminary` |
| **Category** | `Security` |
...
|---------------|-----------------|-------------|----------|
| CP-299 | Federated Learning | Train without centralizing data | Should Have |
...
|---------------|-----------------|-------------|-------|----------------------|
| CP-299 | Federated Learning | Train without centralizing data | L2 | Provides infrastructure platform for federated learning |
...
|-------------|---------------|-------------|----------------------|
| UC-005 | Document Processing | AI Document Processing for applications and compliance verification. | Platform infrastructure for Document Processing |
...
| [UC-011](../../../../01-motivation/03-use-cases/use-cases/UC-011/index.md) | Fincrime | Name screening, OCDD, ECDD and TM narrative writing. | Platform infrastructure for Fincrime |
| UC-014 | User Onboarding | AI streamlines onboarding by automating verification and compliance checks. | Platform infrastructure for Onboarding |

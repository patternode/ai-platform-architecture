...
|----------|-------|
| **ABB ID** | `AB-084` |
| **ABB Name** | Model Quantization Service |
| **Version** | `1.0.0` |
| **Status** | `Preliminary` |
| **Category** | `Model` |
...
**Description**:
Optimizes models through quantization
...
|---------------|-----------------|-------------|----------|
| CP-209 | Model Quantization | Optimize models for inference | Should Have |
...
|---------------|-----------------|-------------|-------|----------------------|
| CP-209 | Model Quantization | Optimize models for inference | L2 | Delivers model quantization as a managed service |

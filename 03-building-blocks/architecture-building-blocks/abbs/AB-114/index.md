...
|----------|-------|
| **ABB ID** | `AB-114` |
| **ABB Name** | PII Detection & Masking Service |
| **Version** | `1.0.0` |
| **Status** | `Preliminary` |
| **Category** | `Security` |
...
|---------------|-----------------|-------------|----------|
| CP-296 | Data Masking | Mask sensitive data | Should Have |
| CP-297 | PII Detection | Detect personally identifiable info | Should Have |
...
|---------------|-----------------|-------------|-------|----------------------|
| CP-296 | Data Masking | Mask sensitive data | L2 | Delivers data masking as a managed service |
| CP-297 | PII Detection | Detect personally identifiable info | L2 | Delivers pii detection as a managed service |

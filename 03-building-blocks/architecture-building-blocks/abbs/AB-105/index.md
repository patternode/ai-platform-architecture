...
|----------|-------|
| **ABB ID** | `AB-105` |
| **ABB Name** | GenAI Quality Monitor |
| **Version** | `1.0.0` |
| **Status** | `Preliminary` |
...
|---------------|-----------------|-------------|----------|
| CP-380 | GenAI Quality Monitoring | Monitor LLM output quality | Should Have |
...
|---------------|-----------------|-------------|-------|----------------------|
| CP-380 | GenAI Quality Monitoring | Monitor LLM output quality | L2 | Continuously monitors and alerts on genai quality monitoring metrics |

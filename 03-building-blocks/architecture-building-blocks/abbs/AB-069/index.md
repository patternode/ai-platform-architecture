...
|----------|-------|
| **ABB ID** | `AB-069` |
| **ABB Name** | Bias Detection Framework |
| **Version** | `1.0.0` |
| **Status** | `Preliminary` |
| **Category** | `Governance` |
...
**Description**:
Detects and reports bias in ML models
...
|---------------|-----------------|-------------|-------|----------------------|
| CP-353 | Bias Detection | Detect and report bias across demographic groups | L2 | Provides standardized framework for bias detection |

...
|----------|-------|
| **ABB ID** | `AB-077` |
| **ABB Name** | Event Consumer Framework |
| **Version** | `1.0.0` |
| **Status** | `Preliminary` |
...
|---------------|-----------------|-------------|----------|
| CP-454 | Event Consumption Framework | Framework for consuming and processing events from various sources | Should Have |
...
|---------------|-----------------|-------------|-------|----------------------|
| CP-454 | Event Consumption Framework | Framework for consuming and processing events from various sources | L2 | Provides standardized framework for event consumption framework |

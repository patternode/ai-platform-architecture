...
|---------------|-----------------|-------------|----------|
| CP-204 | Model Rollback | Rollback to previous model versions | Should Have |
...
|---------------|-----------------|-------------|-------|----------------------|
| CP-204 | Model Rollback | Rollback to previous model versions | L2 | Controls and manages model rollback operations |
| CP-347 | Model Versioning | Track model versions and enable rollback | L2 | Controls and manages model versioning operations |

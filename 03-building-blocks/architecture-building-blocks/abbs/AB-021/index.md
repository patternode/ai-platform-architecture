...
|----------|-------|
| **ABB ID** | `AB-021` |
| **ABB Name** | Drift Detection Monitor |
| **Version** | `1.0.0` |
| **Status** | `Preliminary` |
| **Category** | `Batch` |
...
|---------------|-----------------|-------------|----------|
| CP-449 | Batch Drift Monitoring | Monitor data and model drift specific to batch prediction workflows | Must Have |
...
|---------------|-----------------|-------------|-------|----------------------|
| CP-449 | Batch Drift Monitoring | Monitor data and model drift specific to batch prediction workflows | L2 | Continuously monitors and alerts on batch drift monitoring metrics |
...
| PT-012 | Data Mesh Pattern | Enable domain-oriented decentralized data ownership with federated governance... | Supporting |
...
| UC-002 | Business Reporting | Transform raw data into well-structured reports and dashboards. | Monitors performance and drift for Finance |
| UC-003 | Analytics and Insights | AI builds on BI by turning historical data into proactive guidance. | Monitors performance and drift for Analytics and Reporting |

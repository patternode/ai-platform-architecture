...
|----------|-------|
| **ABB ID** | `AB-092` |
| **ABB Name** | A/B Test Configuration Service |
| **Version** | `1.0.0` |
| **Status** | `Preliminary` |
| **Category** | `MLOps` |
...
**Description**:
Configures and manages A/B tests
...
|---------------|-----------------|-------------|----------|
| CP-455 | A/B Test Configuration | Configure and manage A/B tests for model comparison | Must Have |
...
|---------------|-----------------|-------------|-------|----------------------|
| CP-455 | A/B Test Configuration | Configure and manage A/B tests for model comparison | L2 | Delivers a/b test configuration as a managed service |

...
|----------|-------|
| **ABB ID** | `AB-068` |
| **ABB Name** | Explainability Service |
| **Version** | `1.0.0` |
| **Status** | `Preliminary` |
| **Category** | `Governance` |
...
|---------------|-----------------|-------------|-------|----------------------|
| CP-352 | Model Explainability | Generate SHAP/LIME explanations for predictions | L2 | Delivers model explainability as a managed service |

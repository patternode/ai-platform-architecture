...
|---------------|-----------------|-------------|----------|
| CP-139 | Citation Generation | Attribute sources in LLM responses | Should Have |
...
|---------------|-----------------|-------------|-------|----------------------|
| CP-139 | Citation Generation | Attribute sources in LLM responses | L2 | Generates citation generation outputs |

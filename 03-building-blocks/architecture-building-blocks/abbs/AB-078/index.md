...
|---------------|-----------------|-------------|----------|
| CP-272 | Dead Letter Handling | Handle failed message processing | Should Have |
...
|---------------|-----------------|-------------|-------|----------------------|
| CP-272 | Dead Letter Handling | Handle failed message processing | L2 | Queues and manages dead letter handling messages |

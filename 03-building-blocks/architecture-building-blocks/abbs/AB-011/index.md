...
|---------------|-----------------|-------------|----------|
| CP-277 | API Gateway | Central API access and routing | Should Have |
| CP-278 | Rate Limiting | Enforce API rate limits | Should Have |
| CP-279 | API Versioning | Manage API versions | Should Have |
| CP-280 | API Analytics | Track API usage and performance | Should Have |
| CP-419 | API Documentation | Interactive API documentation | Should Have |
...
|---------------|-----------------|-------------|-------|----------------------|
| CP-277 | API Gateway | Central API access and routing | L2 | Provides unified API access for api gateway |
| CP-278 | Rate Limiting | Enforce API rate limits | L2 | Provides unified API access for rate limiting |
| CP-279 | API Versioning | Manage API versions | L2 | Provides unified API access for api versioning |
| CP-280 | API Analytics | Track API usage and performance | L2 | Provides unified API access for api analytics |
| CP-419 | API Documentation | Interactive API documentation | L2 | Provides unified API access for api documentation |
...
|-------------|---------------|-------------|----------------------|
| UC-001 | Customer Relationship Management | AI-driven relationship management platform that automates meeting preparation and client insights. | API gateway for Customer Relationship Management services |
| UC-002 | Business Reporting | Transform raw data into well-structured reports and dashboards. | API gateway for Finance services |
| UC-003 | Analytics and Insights | AI builds on BI by turning historical data into proactive guidance. | API gateway for Analytics and Reporting services |
...
| UC-005 | Document Processing | AI Document Processing for applications and compliance verification. | API gateway for Document Processing services |
...
| UC-007 | Customer Service | Generate interaction summaries, agent-assist features, customer self-service. | API gateway for Customer Service services |
...
| [UC-009](../../../../01-motivation/03-use-cases/use-cases/UC-009/index.md) | Data Products | Extend GenAI intervention to accelerate data product creation. | API gateway for Data Products services |
| UC-010 | Software Development | GenAI can automate key development tasks, enhancing productivity. | API gateway for SDLC services |
...
| UC-012 | Quality Assurance | Automate data validation, detecting errors, ensuring compliance. | API gateway for Quality Assurance services |
...
| UC-016 | IT Operations | Evolution of Ticketing Process and Smart Routing. | API gateway for IT Operations services |
| UC-017 | Enterprise Relationship Management | GenAI-driven relationship management solutions for enterprise clients. | API gateway for Enterprise Relationship Management services |
| UC-018 | Procurement | Multi-Agent System for End-to-end Procurement process optimization. | API gateway for Procurement services |
...
| UC-020 | Controls Testing | Automate IT and business control testing. | API gateway for Controls Testing services |
...
| UC-022 | Learning Content | AI accelerates content creation by generating lessons and training materials. | API gateway for Learning Content services |
| [UC-023](../../../../01-motivation/03-use-cases/use-cases/UC-023/index.md) | Collection Management | AI optimises collections by predicting payment likelihood. | API gateway for Collection Management services |
| [UC-024](../../../../01-motivation/03-use-cases/use-cases/UC-024/index.md) | Front-end App Personalisation | Use of GenAI in mobile app for hyper personalisation. | API gateway for Front-end App Personalisation services |

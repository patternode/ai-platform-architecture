...
|---------------|-----------------|-------------|----------|
| CP-136 | Hybrid Search | Combine keyword and semantic search | Should Have |
...
|---------------|-----------------|-------------|-------|----------------------|
| CP-136 | Hybrid Search | Combine keyword and semantic search | L2 | Core processing engine that generates hybrid search |

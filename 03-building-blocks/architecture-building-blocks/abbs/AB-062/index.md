...
|----------|-------|
| **ABB ID** | `AB-062` |
| **ABB Name** | Approval Workflow Orchestrator |
| **Version** | `1.0.0` |
| **Status** | `Preliminary` |
| **Category** | `Governance` |
...
|---------------|-----------------|-------------|----------|
| CP-346 | Model Approval Workflow | Multi-level approval gates for model deployment | Should Have |
...
|---------------|-----------------|-------------|-------|----------------------|
| CP-346 | Model Approval Workflow | Multi-level approval gates for model deployment | L2 | Coordinates and manages model approval workflow workflows and execution |

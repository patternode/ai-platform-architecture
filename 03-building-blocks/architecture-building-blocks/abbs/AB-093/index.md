...
|---------------|-----------------|-------------|----------|
| CP-424 | Feature Flags | Control feature rollout | Should Have |
...
|---------------|-----------------|-------------|-------|----------------------|
| CP-424 | Feature Flags | Control feature rollout | L2 | Delivers feature flags as a managed service |

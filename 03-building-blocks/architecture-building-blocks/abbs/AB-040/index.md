...
|----------|-------|
| **ABB ID** | `AB-040` |
| **ABB Name** | Document Classification Engine |
| **Version** | `1.0.0` |
| **Status** | `Preliminary` |
| **Category** | `Document` |
...
|---------------|-----------------|-------------|----------|
| CP-147 | Document Classification | Categorize documents by type | Should Have |
...
|---------------|-----------------|-------------|-------|----------------------|
| CP-147 | Document Classification | Categorize documents by type | L2 | Core processing engine that processes document classification |

...
|----------|-------|
| **ABB ID** | `AB-045` |
| **ABB Name** | Data Contract Registry |
| **Version** | `1.0.0` |
| **Status** | `Preliminary` |
| **Category** | `DataMesh` |
...
|---------------|-----------------|-------------|----------|
| CP-258 | Data Contracts | Define and enforce data quality contracts | Should Have |
...
|---------------|-----------------|-------------|-------|----------------------|
| CP-258 | Data Contracts | Define and enforce data quality contracts | L2 | Provides centralized registration and versioning for data contracts |

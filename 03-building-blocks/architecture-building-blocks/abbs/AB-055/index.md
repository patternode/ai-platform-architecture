...
|---------------|-----------------|-------------|----------|
| CP-137 | Document Reranking | Rerank retrieved documents for relevance | Should Have |
...
|---------------|-----------------|-------------|-------|----------------------|
| CP-137 | Document Reranking | Rerank retrieved documents for relevance | L2 | Core processing engine that generates document reranking |

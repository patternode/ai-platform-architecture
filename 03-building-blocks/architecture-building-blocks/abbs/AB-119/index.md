...
|----------|-------|
| **ABB ID** | `AB-119` |
| **ABB Name** | Differential Privacy Engine |
| **Version** | `1.0.0` |
| **Status** | `Preliminary` |
| **Category** | `Security` |
...
|---------------|-----------------|-------------|----------|
| CP-298 | Differential Privacy | Add noise to protect privacy | Should Have |
...
|---------------|-----------------|-------------|-------|----------------------|
| CP-298 | Differential Privacy | Add noise to protect privacy | L2 | Core processing engine that secures differential privacy |

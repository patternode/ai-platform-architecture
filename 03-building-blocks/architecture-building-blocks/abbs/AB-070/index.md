...
|---------------|-----------------|-------------|----------|
| CP-357 | Data Lineage | Track data flow from source to prediction | Should Have |
| CP-358 | Model Lineage | Track model dependencies and training data | Should Have |
...
|---------------|-----------------|-------------|-------|----------------------|
| CP-357 | Data Lineage | Track data flow from source to prediction | L2 | Tracks and maintains history of data lineage |
| CP-358 | Model Lineage | Track model dependencies and training data | L2 | Tracks and maintains history of model lineage |

...
|---------------|-----------------|-------------|----------|
| CP-011 | Entity Extraction | Extract entities from text | Should Have |
...
|---------------|-----------------|-------------|-------|----------------------|
| CP-011 | Entity Extraction | Extract entities from text | L2 | Enables extract entities from text |

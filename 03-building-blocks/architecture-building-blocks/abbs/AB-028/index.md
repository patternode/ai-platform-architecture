...
|----------|-------|
| **ABB ID** | `AB-028` |
| **ABB Name** | Model Promotion Service |
| **Version** | `1.0.0` |
| **Status** | `Preliminary` |
...
|---------------|-----------------|-------------|----------|
| CP-208 | Model Promotion | Promote challenger to champion | Should Have |
...
|---------------|-----------------|-------------|-------|----------------------|
| CP-208 | Model Promotion | Promote challenger to champion | L2 | Delivers model promotion as a managed service |

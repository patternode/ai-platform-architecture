...
|----------|-------|
| **ABB ID** | `AB-071` |
| **ABB Name** | Model Performance Benchmarking |
| **Version** | `1.0.0` |
| **Status** | `Preliminary` |
| **Category** | `Governance` |
...
|---------------|-----------------|-------------|----------|
| CP-452 | Model Performance Benchmarking | Benchmark model performance against baselines and industry standards | Should Have |
...
|---------------|-----------------|-------------|-------|----------------------|
| CP-452 | Model Performance Benchmarking | Benchmark model performance against baselines and industry standards | L2 | Enables benchmark model performance against baselines and industry standards |

...
|---------------|-----------------|-------------|----------|
| CP-016 | Human Handoff | Escalate to human agents | Should Have |
...
|---------------|-----------------|-------------|-------|----------------------|
| CP-016 | Human Handoff | Escalate to human agents | L2 | Core processing engine that manages human handoff |

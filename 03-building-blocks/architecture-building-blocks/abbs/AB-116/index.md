...
|----------|-------|
| **ABB ID** | `AB-116` |
| **ABB Name** | Audit Logging & Monitoring |
| **Version** | `1.0.0` |
| **Status** | `Preliminary` |
| **Category** | `Security` |
...
|---------------|-----------------|-------------|----------|
| CP-302 | Threat Detection | Detect security threats | Should Have |
| CP-305 | Security Audit Logging | Log security events | Should Have |
...
|---------------|-----------------|-------------|-------|----------------------|
| CP-302 | Threat Detection | Detect security threats | L2 | Continuously monitors and alerts on threat detection metrics |
| CP-305 | Security Audit Logging | Log security events | L2 | Continuously monitors and alerts on security audit logging metrics |

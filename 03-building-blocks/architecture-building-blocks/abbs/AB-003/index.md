...
|---------------|-----------------|-------------|----------|
| CP-107 | Agent Memory | Short and long-term agent memory | Should Have |
...
|---------------|-----------------|-------------|-------|----------------------|
| CP-107 | Agent Memory | Short and long-term agent memory | L2 | Enables short and long-term agent memory |

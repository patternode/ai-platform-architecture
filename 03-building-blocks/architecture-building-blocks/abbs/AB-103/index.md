...
|----------|-------|
| **ABB ID** | `AB-103` |
| **ABB Name** | Business Metrics Tracker |
| **Version** | `1.0.0` |
| **Status** | `Preliminary` |
...
|---------------|-----------------|-------------|----------|
| CP-377 | Business Metrics | Link model to business outcomes | Should Have |
...
|---------------|-----------------|-------------|-------|----------------------|
| CP-377 | Business Metrics | Link model to business outcomes | L2 | Tracks and maintains history of business metrics |

...
|----------|-------|
| **ABB ID** | `AB-112` |
| **ABB Name** | Data Encryption Service |
| **Version** | `1.0.0` |
| **Status** | `Preliminary` |
| **Category** | `Security` |
...
|---------------|-----------------|-------------|----------|
| CP-294 | Encryption at Rest | Encrypt stored data | Should Have |
| CP-295 | Encryption in Transit | Encrypt data in motion | Should Have |
...
|---------------|-----------------|-------------|-------|----------------------|
| CP-294 | Encryption at Rest | Encrypt stored data | L2 | Delivers encryption at rest as a managed service |
| CP-295 | Encryption in Transit | Encrypt data in motion | L2 | Delivers encryption in transit as a managed service |

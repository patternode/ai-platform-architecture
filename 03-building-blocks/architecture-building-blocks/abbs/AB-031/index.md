...
|---------------|-----------------|-------------|----------|
| CP-012 | Response Generation | Generate natural responses | Should Have |
...
|---------------|-----------------|-------------|-------|----------------------|
| CP-012 | Response Generation | Generate natural responses | L2 | Generates response generation outputs |

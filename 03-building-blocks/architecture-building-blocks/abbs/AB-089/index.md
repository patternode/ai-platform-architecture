...
|----------|-------|
| **ABB ID** | `AB-089` |
| **ABB Name** | Model Monitoring Platform |
| **Version** | `1.0.0` |
| **Status** | `Preliminary` |
| **Category** | `MLOps` |
...
|---------------|-----------------|-------------|----------|
| CP-201 | Model Monitoring | Monitor model performance in production | Should Have |
...
|---------------|-----------------|-------------|-------|----------------------|
| CP-201 | Model Monitoring | Monitor model performance in production | L2 | Continuously monitors and alerts on model monitoring metrics |

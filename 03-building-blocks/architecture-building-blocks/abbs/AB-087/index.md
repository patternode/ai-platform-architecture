...
|----------|-------|
| **ABB ID** | `AB-087` |
| **ABB Name** | Model Testing Framework |
| **Version** | `1.0.0` |
| **Status** | `Preliminary` |
| **Category** | `MLOps` |
...
|---------------|-----------------|-------------|----------|
| CP-196 | Model Validation | Validate models before deployment | Should Have |
...
|---------------|-----------------|-------------|-------|----------------------|
| CP-196 | Model Validation | Validate models before deployment | L2 | Provides standardized framework for model validation |

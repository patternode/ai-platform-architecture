...
|----------|-------|
| **ABB ID** | `AB-057` |
| **ABB Name** | Document Processing Pipeline |
| **Version** | `1.0.0` |
| **Status** | `Preliminary` |
| **Category** | `GenAI` |
...
|---------------|-----------------|-------------|----------|
| CP-151 | Document Processing Pipeline | End-to-end document processing | Should Have |
| CP-254 | Document Indexing | Process and index documents for retrieval | Should Have |
...
|---------------|-----------------|-------------|-------|----------------------|
| CP-151 | Document Processing Pipeline | End-to-end document processing | L2 | Automates end-to-end document processing pipeline workflows |
| CP-254 | Document Indexing | Process and index documents for retrieval | L2 | Automates end-to-end document indexing workflows |
...
| PT-011 | Intelligent Document Processing (IDP) | Automated extraction, classification, and validation of data from structured ... | Supporting |
...
| UC-003 | Analytics and Insights | AI builds on BI by turning historical data into proactive guidance. | Automates workflows for Analytics and Reporting |
...
| UC-005 | Document Processing | AI Document Processing for applications and compliance verification. | Automates workflows for Document Processing |
| UC-007 | Customer Service | Generate interaction summaries, agent-assist features, customer self-service. | Automates workflows for Customer Service |
| [UC-009](../../../../01-motivation/03-use-cases/use-cases/UC-009/index.md) | Data Products | Extend GenAI intervention to accelerate data product creation. | Automates workflows for Data Products |
| UC-012 | Quality Assurance | Automate data validation, detecting errors, ensuring compliance. | Automates workflows for Quality Assurance |
...
| UC-016 | IT Operations | Evolution of Ticketing Process and Smart Routing. | Automates workflows for IT Operations |
| UC-017 | Enterprise Relationship Management | GenAI-driven relationship management solutions for enterprise clients. | Automates workflows for Enterprise Relationship Management |
| UC-018 | Procurement | Multi-Agent System for End-to-end Procurement process optimization. | Automates workflows for Procurement |
| UC-020 | Controls Testing | Automate IT and business control testing. | Automates workflows for Controls Testing |
...
| UC-022 | Learning Content | AI accelerates content creation by generating lessons and training materials. | Automates workflows for Learning Content |

...
|----------|-------|
| **ABB ID** | `AB-122` |
| **ABB Name** | Secure Multi-Party Computation |
| **Version** | `1.0.0` |
| **Status** | `Preliminary` |
| **Category** | `Security` |
...
|---------------|-----------------|-------------|----------|
| CP-301 | Secure Multi-Party Computation | Secure cross-party computation | Should Have |
...
|---------------|-----------------|-------------|-------|----------------------|
| CP-301 | Secure Multi-Party Computation | Secure cross-party computation | L2 | Enables secure cross-party computation |

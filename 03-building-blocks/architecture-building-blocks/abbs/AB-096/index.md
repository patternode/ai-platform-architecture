...
|----------|-------|
| **ABB ID** | `AB-096` |
| **ABB Name** | Observability Platform |
| **Version** | `1.0.0` |
| **Status** | `Preliminary` |
...
|---------------|-----------------|-------------|----------|
| CP-369 | Metrics Collection | Collect platform metrics | Should Have |
| CP-370 | Log Aggregation | Centralize logs from all services | Should Have |
| CP-371 | Distributed Tracing | Trace requests across services | Should Have |
| CP-373 | Performance Monitoring | Track accuracy, latency, throughput | Should Have |
| CP-384 | Root Cause Analysis | Investigate performance issues | Should Have |
...
|---------------|-----------------|-------------|-------|----------------------|
| CP-369 | Metrics Collection | Collect platform metrics | L2 | Provides infrastructure platform for metrics collection |
| CP-370 | Log Aggregation | Centralize logs from all services | L2 | Provides infrastructure platform for log aggregation |
| CP-371 | Distributed Tracing | Trace requests across services | L2 | Provides infrastructure platform for distributed tracing |
| CP-373 | Performance Monitoring | Track accuracy, latency, throughput | L2 | Provides infrastructure platform for performance monitoring |
| CP-384 | Root Cause Analysis | Investigate performance issues | L2 | Provides infrastructure platform for root cause analysis |
...
|-------------|---------------|-------------|----------------------|
| UC-001 | Customer Relationship Management | AI-driven relationship management platform that automates meeting preparation and client insights. | Platform infrastructure for Customer Relationship Management |
| UC-007 | Customer Service | Generate interaction summaries, agent-assist features, customer self-service. | Platform infrastructure for Customer Service |
| [UC-008](../../../../01-motivation/03-use-cases/use-cases/UC-008/index.md) | Security AI | Use of AI to identify threats earlier with higher accuracy. | Platform infrastructure for Security AI |
| [UC-009](../../../../01-motivation/03-use-cases/use-cases/UC-009/index.md) | Data Products | Extend GenAI intervention to accelerate data product creation. | Platform infrastructure for Data Products |
| UC-010 | Software Development | GenAI can automate key development tasks, enhancing productivity. | Platform infrastructure for SDLC |
| UC-012 | Quality Assurance | Automate data validation, detecting errors, ensuring compliance. | Platform infrastructure for Quality Assurance |
| [UC-015](../../../../01-motivation/03-use-cases/use-cases/UC-015/index.md) | Risk Functions | AI reduces Operational Risk by identifying anomalies. | Platform infrastructure for Risk Functions |
| UC-016 | IT Operations | Evolution of Ticketing Process and Smart Routing. | Platform infrastructure for IT Operations |
| UC-017 | Enterprise Relationship Management | GenAI-driven relationship management solutions for enterprise clients. | Platform infrastructure for Enterprise Relationship Management |
| UC-018 | Procurement | Multi-Agent System for End-to-end Procurement process optimization. | Platform infrastructure for Procurement |
| UC-020 | Controls Testing | Automate IT and business control testing. | Platform infrastructure for Controls Testing |
| UC-022 | Learning Content | AI accelerates content creation by generating lessons and training materials. | Platform infrastructure for Learning Content |
| [UC-023](../../../../01-motivation/03-use-cases/use-cases/UC-023/index.md) | Collection Management | AI optimises collections by predicting payment likelihood. | Platform infrastructure for Collection Management |

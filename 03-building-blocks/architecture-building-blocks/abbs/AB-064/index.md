...
|---------------|-----------------|-------------|----------|
| CP-349 | Compliance Monitoring | Track compliance with GDPR, AML, Model Risk policies | Should Have |
| CP-350 | Regulatory Reporting | Generate compliance reports for regulators | Should Have |
...
|---------------|-----------------|-------------|-------|----------------------|
| CP-349 | Compliance Monitoring | Track compliance with GDPR, AML, Model Risk policies | L2 | Visualizes and reports on compliance monitoring metrics |
| CP-350 | Regulatory Reporting | Generate compliance reports for regulators | L2 | Visualizes and reports on regulatory reporting metrics |

...
|----------|-------|
| **ABB ID** | `AB-008` |
| **ABB Name** | Human-in-the-Loop Gateway |
| **Version** | `1.0.0` |
| **Status** | `Preliminary` |
| **Category** | `Agentic` |
...
|---------------|-----------------|-------------|----------|
| CP-118 | Human-in-the-Loop | Approval gates for high-risk actions | Should Have |
...
|---------------|-----------------|-------------|-------|----------------------|
| CP-118 | Human-in-the-Loop | Approval gates for high-risk actions | L2 | Provides unified API access for human-in-the-loop |

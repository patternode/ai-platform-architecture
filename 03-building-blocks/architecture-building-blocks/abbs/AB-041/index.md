...
|---------------|-----------------|-------------|----------|
| CP-148 | OCR & Text Extraction | Extract text from images/scans | Should Have |
...
|---------------|-----------------|-------------|-------|----------------------|
| CP-148 | OCR & Text Extraction | Extract text from images/scans | L2 | Core processing engine that processes ocr & text extraction |

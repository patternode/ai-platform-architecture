...
|----------|-------|
| **ABB ID** | `AB-053` |
| **ABB Name** | Query Intent Analyzer |
| **Version** | `1.0.0` |
| **Status** | `Preliminary` |
| **Category** | `GenAI` |
...
|---------------|-----------------|-------------|----------|
| CP-024 | Query Understanding | Understand complex queries | Should Have |
...
|---------------|-----------------|-------------|-------|----------------------|
| CP-024 | Query Understanding | Understand complex queries | L2 | Analyzes and extracts insights for query understanding |

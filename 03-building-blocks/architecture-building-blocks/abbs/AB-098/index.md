...
|----------|-------|
| **ABB ID** | `AB-098` |
| **ABB Name** | Prediction Drift Monitor |
| **Version** | `1.0.0` |
| **Status** | `Preliminary` |
...
| CP-375 | Prediction Drift Detection | Detect output distribution changes | Should Have |
...
|---------------|-----------------|-------------|-------|----------------------|
| CP-202 | Drift Detection | Detect data and concept drift | L2 | Continuously monitors and alerts on drift detection metrics |
| CP-375 | Prediction Drift Detection | Detect output distribution changes | L2 | Continuously monitors and alerts on prediction drift detection metrics |

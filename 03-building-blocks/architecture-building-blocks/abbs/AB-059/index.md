...
|----------|-------|
| **ABB ID** | `AB-059` |
| **ABB Name** | Query Rewriting Engine |
| **Version** | `1.0.0` |
| **Status** | `Preliminary` |
| **Category** | `GenAI` |
...
|---------------|-----------------|-------------|----------|
| CP-138 | Query Rewriting | Reformulate queries for better retrieval | Should Have |
...
|---------------|-----------------|-------------|-------|----------------------|
| CP-138 | Query Rewriting | Reformulate queries for better retrieval | L2 | Core processing engine that generates query rewriting |

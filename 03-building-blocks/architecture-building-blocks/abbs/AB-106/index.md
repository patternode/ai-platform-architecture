...
|----------|-------|
| **ABB ID** | `AB-106` |
| **ABB Name** | Automated Retraining Trigger |
| **Version** | `1.0.0` |
| **Status** | `Preliminary` |
...
|---------------|-----------------|-------------|----------|
| CP-203 | Automated Retraining | Trigger retraining based on drift | Should Have |
...
|---------------|-----------------|-------------|-------|----------------------|
| CP-203 | Automated Retraining | Trigger retraining based on drift | L2 | Triggers automated actions for automated retraining |

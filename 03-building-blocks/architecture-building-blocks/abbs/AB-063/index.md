...
|----------|-------|
| **ABB ID** | `AB-063` |
| **ABB Name** | ML Model Explainability Engine |
| **Version** | `1.0.0` |
| **Status** | `Preliminary` |
| **Category** | `Governance` |
...
|---------------|-----------------|-------------|----------|
| CP-352 | Model Explainability | Generate SHAP/LIME explanations for predictions | Should Have |
...
|---------------|-----------------|-------------|-------|----------------------|
| CP-352 | Model Explainability | Generate SHAP/LIME explanations for predictions | L2 | Core processing engine that governs model explainability |

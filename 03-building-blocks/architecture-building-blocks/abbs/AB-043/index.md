...
|---------------|-----------------|-------------|----------|
| CP-250 | Data Catalog | Discover and understand available data | Should Have |
| CP-256 | Data Product Catalog | Publish and discover data products | Should Have |
...
|---------------|-----------------|-------------|-------|----------------------|
| CP-250 | Data Catalog | Discover and understand available data | L2 | Catalogs and discovers data catalog assets |
| CP-256 | Data Product Catalog | Publish and discover data products | L2 | Catalogs and discovers data product catalog assets |
